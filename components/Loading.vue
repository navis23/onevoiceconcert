<template>
        ...
        <div class="fixed inset-0 flex items-center justify-center p-4 h-screen z-50">
        <!-- The actual dialog panel -->
            <div class="w-full max-w-xs py-6 px-2 rounded-lg bg-stone-200">
                <div class="flex gap-x-2 justify-center items-center">
                    ...
                    <button class="font-semibold text-xl tracking-widest text-yellow-600">Loading . . . </button>
                </div>
            </div>
        </div>
